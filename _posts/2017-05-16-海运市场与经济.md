...
> Answer:The consumer demand and profit-maximizing input demandis both the demand that are needed in the market that offered and purchased to the public. Both of these two are dynamicly matched with the supply and involved with shippment.
> 
> The consumer demand is the real need in the terminal consuming and consumed directly by the consumer, but the profit-maximizing input demand a concept of demand that used to reproduce, it is a intermedia concept,it takes the profit-maximizing principle into consideration,balances the efficiency and the quality.
> The consumer and the producer both will adjust themslves by assigning different location along the demamd and supply curve, the balance point is the dynamic price waving in the market. when the market price increase,the producer tends to increase the product to gain the supply so that to maxmize their revenue but at the same time as the supply surpluses,the price would decrease,which would lead to disencourage the producers.
...
===
1. MOL ordered six 20,150 TEU container vessels at March 2, 2015, each costs $155 million.
...
2. A new containership of 3500TEU cost $45.6 million in 2011. Assuming that the daily operation cost is $8,040, C&F cost is $7,496 (depreciation included), 25 year lifespan, no terminal value and 5% discount rate, what is the required daily charter rate? 
